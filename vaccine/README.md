...
**Cybersecurity Piscine** · Scanner d'injection SQL, écrit en Rust.
...
- **Contrainte du projet :** aucune bibliothèque n'automatisant l'injection SQL. Le HTTP est une crate, la logique d'injection est écrite à la main. Voir [feuille de route § 1](docs/00-feuille-de-route.md).
...
## Licence & cadre
 ...
 Usage strictement légal et autorisé — voir la section « Sécurité et limites » du [sujet](docs/vaccine.md#-sécurité-et-limites).
